...
router.post('/', [verifyEncargado, checkDuplicateProducts], producController.handleNewProduct);
router.get('/', [verifyEmpleado], producController.getProductsByOrganization);
router.put('/:id', [verifyEncargado, checkDuplicateProducts], producController.handleUpdateProduct);
